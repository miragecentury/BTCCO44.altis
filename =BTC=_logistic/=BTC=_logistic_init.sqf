...
if (BTC_active_lift == 1) then
{
	...
	BTC_def_hud       = 1;
	BTC_def_pip       = 1;
	BTC_l_def_veh_pip = ["B_Heli_Light_01_F","O_Heli_Light_02_F","B_Heli_Transport_01_F","B_Heli_Transport_01_camo_F","I_Heli_Transport_02_F"];
	...
	BTC_get_liftable_array =
	{
		...
		switch (typeOf _chopper) do
		{
			...
			//UH80
			case "B_Heli_Transport_01_F" : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","StaticWeapon","Car","Truck","Wheeled_APC","Air","Ship"] + BTC_fob_materials;};
			//UH80 camo
			case "B_Heli_Transport_01_camo_F" : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","StaticWeapon","Car","Truck","Wheeled_APC","Air","Ship"] + BTC_fob_materials;};
			//CH49 "HBarrier_base_F","Land_BagFence_Long_F","Land_BarGate_F"
			case "I_Heli_Transport_02_F" : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","StaticWeapon","Car","Truck","Wheeled_APC","Tracked_APC","APC_Tracked_01_base_F","APC_Tracked_02_base_F","Air","Ship","Tank"] + BTC_fob_materials;};
		};
		_array
	};
};
...
if (BTC_active_cargo == 1) then
{
	...
	BTC_def_cargo        = ["Motorcycle","ReammoBox","ReammoBox_F","Land_BarGate_F","HBarrier_base_F","Land_BagFence_Long_F","thingX","Wall_F","BagBunker_base_F"] + BTC_fob_materials;
	BTC_def_drag         = ["ReammoBox_F"];
	BTC_def_placement    = ["ReammoBox","ReammoBox_F","Land_BarGate_F","HBarrier_base_F","Land_BagFence_Long_F","thingX","Wall_F","BagBunker_base_F"] + BTC_fob_materials;
